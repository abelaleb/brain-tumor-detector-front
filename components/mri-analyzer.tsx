...
export default function MriAnalyzer() {
  ...
  const analyzeImage = async (imageData: string) => {
    ...
    try {
      ...
      // Validate and cast result to expected type
      const formattedResult: AnalysisResult = {
        prediction: data.prediction,
        confidence: data.confidence || 100, // default if confidence not returned
        heatmapUrl: data.heatmapUrl || undefined,
      };
        ...
        <div className="space-y-8">
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="pt-2">
                        ...
                        <p className="text-sm text-gray-600 dark:text-gray-400">
                          ...
                          should not be considered a medical diagnosis. Please
          ...
          <div className="flex justify-between">
            <Button
              ...
              className="flex items-center gap-2 bg-black text-white hover:bg-gray-950 hover:text-white cursor-pointer"
